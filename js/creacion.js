...
function creacionDeProductos () { //inicia el loop de cantidad y luego lo evalua para ver si ejecuta la funcion de validacion y carga de datos
    ...
    //se sacan las ejecuciones de los renderizados del condicional
    //para que se rendericen SIEMPRE, no solamente cuando el usuario quiere ingresar productos nuevos (cantidad>0)
    renderizadoConEach('todos',productosDelAlmacenamiento) //va a renderizar todos los productos
    filter('mayores',productosDelAlmacenamiento) //va a renderizar los productos mayores a 2015
}
